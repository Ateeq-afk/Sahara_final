    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-6">
        ...
        >
          ...
          <h1 className="text-4xl font-semibold mb-4 text-gray-900">Thank You!</h1>
        ...
        <div className="relative max-w-7xl mx-auto px-6 lg:px-8 py-16 lg:py-24">
          ...
          >
            <div className="text-center">
              <div className="text-3xl lg:text-4xl font-bold text-gray-900 mb-1">100+</div>
              <div className="text-sm text-gray-600">Projects Delivered</div>
            </div>
            <div className="text-center">
              <div className="text-3xl lg:text-4xl font-bold text-gray-900 mb-1">30min</div>
          ...
          >
            ...
            <p className="mt-6 text-gray-600">
              ...
              <a href="tel:+919591837216" className="text-amber-600 font-semibold hover:text-amber-700 hover:underline">
                +91 95918 37216
              </a>
            </p>
          </motion.div>
